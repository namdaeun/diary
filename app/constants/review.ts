export const REVIEWS = [
  ...
  },
  {
    ...
    info: 'Tiki 웹 프론트엔드 개발자',
    description:
      '사람들이 힘들어 속도가 나지않을때는 본인이 직접 나서서 여러운 테스크들도 가져가서 응차응차해내고 힘들텐데도 우리한테 힘든내색없이 잘 해내는 책임감이 엄청난 다은언니였습니다. 하는 대로 금방금방 팀원들과 상황공유를 잘하고 다른 팀원(나)의 못하는 실력을 이해하고 본인이 더 도와줄건없는지 항상 보살펴주는 이타심과 리더쉽을 가지고잇습니다!',
  },
  {
    id: 6,
    name: '노하은',
    ...
    description:
      '다은이는 사용자가 더 나은 경험을 할 수 있도록 고민하고 디자이너와 적극적인 소통과 하는 개발자입니다. 능력도 우수하여 디자이너가 높은 만족도를 가지고 있습니다.',
  },
];
