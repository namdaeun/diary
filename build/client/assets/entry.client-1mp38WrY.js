...
function z(d) {
  ...
  for (const [a, e] of w)
    if (e && e.__type === 'RouteErrorResponse')
      ...
      if (e.__subType) {
        const i = window[e.__subType];
        if (typeof i == 'function')
          try {
            const o = new i(e.message);
...
function A(d) {
  if (!t) {
    if (window.__remixContext.future.unstable_singleFetch) {
      if (!n) {
        const u = window.__remixContext.stream;
    ...
    if (!window.__remixContext.isSpaMode) {
      ...
      const u = g(i, window.location, window.__remixContext.basename);
      if (u)
        for (const l of u) {
          const _ = l.route.id,
    ...
    (t = F({
      ...
      unstable_dataStrategy: window.__remixContext.future.unstable_singleFetch
        ...
        : void 0,
      unstable_patchRoutesOnNavigation: P(
